...
namespace VForValidator.Models
{
    ...
    public class RegisterViewModel
    {
        ...
        [Required]
        [EmailAddress]
        [Display(Name = "Email", Description = "User email for contacting")]
        [System.Web.Mvc.Remote("DoesEmailExist", "Account", HttpMethod = "POST", ErrorMessage = "Email already exists. Please enter a different userName.")]
        public string Email { get; set; }
